...
import { AcceptNFTOfferRequest, BurnNFTRequest, CancelNFTOfferRequest, CancelOfferRequest, CreateNFTOfferRequest, CreateOfferRequest, EventLoginResponse, EventLogoutResponse, EventNetworkChangedResponse, EventWalletChangedResponse, MintNFTRequest, SendPaymentRequest, SendPaymentRequestDeprecated, SetAccountRequest, SetTrustlineRequest, SetTrustlineRequestDeprecated, SignMessageRequest, SubmitTransactionRequest, WebsiteRequest } from '../payload/payload.types';
interface MessageEventData {
    app: typeof GEM_WALLET;
    type: RequestMessage;
    source: 'GEM_WALLET_MSG_REQUEST';
    messageId: number;
    payload?: AcceptNFTOfferRequest | BurnNFTRequest | CancelNFTOfferRequest | CancelOfferRequest | CreateNFTOfferRequest | CreateOfferRequest | MintNFTRequest | SendPaymentRequest | SendPaymentRequestDeprecated | SetAccountRequest | SetTrustlineRequest | SetTrustlineRequestDeprecated | SignMessageRequest | SubmitTransactionRequest | WebsiteRequest;
}
...
export declare type EventListener = AcceptNFTOfferEventListener | AddressEventListener | AddressEventListenerDeprecated | BurnNFTEventListener | CancelNFTOfferEventListener | CancelOfferEventListener | CreateNFTOfferEventListener | CreateOfferEventListener | GetNFTEventListener | GetNFTEventListenerDeprecated | MintNFTEventListener | NetworkEventListener | NetworkEventListenerDeprecated | PublicKeyEventListener | PublicKeyEventListenerDeprecated | PaymentEventListener | PaymentEventListenerDeprecated | SetAccountEventListener | SetTrustlineEventListener | SetTrustlineEventListenerDeprecated | SignMessageListener | SignMessageListenerDeprecated | SubmitTransactionEventListener;
...
export declare type EventEventListener = EventNetworkChangedEventListener | EventWalletChangedEventListener | EventLoginEventListener | EventLogoutEventListener;
export {};
